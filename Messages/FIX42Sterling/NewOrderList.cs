    ...
    namespace FIX42Sterling 
    {
        public class NewOrderList : Message
        {
            ...
            public class NoOrdersGroup : Group
            {
                ...
                public QuickFix.Fields.StopPrice StopPrice
                { 
                    get 
                    {
                        QuickFix.Fields.StopPrice val = new QuickFix.Fields.StopPrice();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.StopPrice val) 
                { 
                    this.StopPrice = val;
                }
                
                public QuickFix.Fields.StopPrice Get(QuickFix.Fields.StopPrice val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.StopPrice val) 
                { 
                    return IsSetStopPrice();
                }
                
                public bool IsSetStopPrice() 
                { 
                    return IsSetField(Tags.StopPrice);
                }
